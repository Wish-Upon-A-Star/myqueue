...
현재 기본 버전은 `Python + customtkinter`로 만든 단일 실행 파일입니다. Electron은 사용하지 않습니다. 기본 Tkinter 테이블 UI를 버리고 발표용으로 보여주기 좋은 카드형 작업 탐색 UI로 구성했습니다.
